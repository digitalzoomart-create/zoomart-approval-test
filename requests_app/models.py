...
class Request(models.Model):
    ...
    STATUS_CHOICES = [
        ...
        (STATUS_PENDING_MANAGER, "მენეჯერის დამტკიცების მოლოდინში"),
        (STATUS_MORE_INFO, "საჭიროა დამატებითი ინფორმაცია"),
        (STATUS_MANAGER_APPROVED, "მენეჯერმა დაამტკიცა"),
        (STATUS_PENDING_FINANCE, "ფინანსების განხილვის მოლოდინში"),
        (STATUS_PENDING_SENIOR, "უფროსი მენეჯმენტის დამტკიცების მოლოდინში"),
